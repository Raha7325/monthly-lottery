    ...
    return (
      <>
        <div className='flex-col mt-[40px] md:mt-0 shadow-md p-4'>
          <div className='mb-10 px-3 py-1 rounded-md bg-gray-200 text-center text-gray-400 font-bold'>صندوق ۵ ام <span className='text-xs'>(شروع از ۰۵-۰۸-۱۴۰۲)</span></div>
          <div className='grid grid-cols-3 gap-x-4 gap-y-5 place-items-center'>
            ...
            <div>
              ...
              <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۳-۰۵-۰۵</h5>
            </div>
            <div>
