    ...
    return(
      <>
        <div className='flex-col mt-[40px] md:mt-0 shadow-md p-4'>
          ...
          <div>
            <div className='w-[50px] h-[50px] rounded-[50px] shadow-md shadow-fuchsia-400 text-fuchsia-400 bg-fuchsia-100 flex items-center justify-center col-span-1'>۶</div>
            <h5 className='text-xs text-transparent pt-2'> .</h5>
          </div>          
          <div>
           <div className='w-[50px] h-[50px] rounded-[50px] shadow-md shadow-fuchsia-400 text-fuchsia-400 bg-fuchsia-100 flex items-center justify-center col-span-1'>۵</div>
           <h5 className='text-xs text-transparent pt-2'> .</h5>
          </div>          
          <div>
          ...
          <div>
           <div className='w-[50px] h-[50px] rounded-[50px] shadow-md shadow-fuchsia-400 text-fuchsia-400 bg-fuchsia-100 flex items-center justify-center col-span-1'>۹</div>
           <h5 className='text-xs text-transparent pt-2'> .</h5>
          </div>             
          <div>
           <div className='w-[50px] h-[50px] rounded-[50px] shadow-md shadow-fuchsia-400 text-fuchsia-400 bg-fuchsia-100 flex items-center justify-center col-span-1'>۸</div>
           <h5 className='text-xs text-transparent pt-2'> .</h5>
          </div>  
          <div>
