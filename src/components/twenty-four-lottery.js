    ...
    return(
      <>
        <div className='flex-col mt-[40px] md:mt-0 shadow-md p-4'>
          <div className='mb-10 px-3 py-1 rounded-md bg-gray-200 text-center text-gray-100 font-bold'>صندوق ۲۴ ام <span className='text-xs'>(شروع از ۲۴-۰۶-۱۴۰۲)</span></div>
          ...
          <div>
           ...
           <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۲-۱۲-۲۴</h5>
          </div>
          <div>
           ...
           <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۳-۰۳-۲۴</h5>
           </div>
          <div>
          ...
          <div>
           ...
           <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۳-۰۱-۲۴</h5>
          </div>             
          <div>
          ...
          <div className='w-[50px] h-[50px] rounded-[50px] shadow-md shadow-gray-200 text-gray-100 bg-gray-200 flex items-center justify-center'>۱۰</div>
           <h5 className='text-xs text-gray-200 pt-2 flex justify-center'>۱۴۰۲-۱۱-۲۴</h5>
          </div>
          </div>
        </div>
      </>
