    ...
    return (
      <>
        <div className='flex-col mt-[40px] md:mt-0 shadow-md p-4'>
          <div className='mb-10 px-3 py-1 rounded-md shadow-gray-200 text-gray-100 bg-gray-200 font-bold text-center'>صندوق ۸ ام <span className='text-xs'>(شروع از ۰۸-۱۰-۱۴۰۲)</span></div>
          <div className='grid grid-cols-3 gap-x-4 gap-y-5 place-items-center'>
            ...
            <div>
              ...
              <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۳-۰۳-۰۸</h5>
            </div>
            <div>
            ...
            <div>
              ...
              <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۳-۰۶-۰۸</h5>
            </div>
            <div>
            ...
            <div className='col-span-3'>
              ...
              <h5 className='text-xs text-gray-200 pt-2 flex justify-center'>۱۴۰۳-۰۵-۰۸</h5>
            </div>
          </div>
        </div>
      </>
