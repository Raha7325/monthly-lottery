    ...
    return (
      <>
        <div className='flex-col mt-[40px] md:mt-0 shadow-md p-4'>
          <div className='mb-10 px-3 py-1 rounded-md bg-gray-200 text-center text-gray-300 font-bold'>صندوق ۲۰ ام <span className='text-xs'>(شروع از ۲۰-۱۲-۱۴۰۲)</span></div>
          <div className='grid grid-cols-3 gap-x-4 gap-y-5 place-items-center'>
            ...
            <div>
              ...
              <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۳-۰۹-۲۰</h5>
            </div>
            <div>
            ...
            <div>
              ...
              <h5 className='text-xs text-gray-200 pt-2'>۱۴۰۳-۰۸-۲۰</h5>
            </div>
